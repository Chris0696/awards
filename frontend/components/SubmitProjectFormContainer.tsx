    ...
    <section className="pb-40 pt-28">
      {/*  <FormCard step={1}>
        <div className="space-y-6">
          ...
          <EmailField label="Adresse e-mail" placeholder="Example@gmail.com" />
        ...
        <div className="mt-16">
          <button className="bg-secondary px-4 py-2 rounded-md text-white w-full cursor-pointer">
            Soumettre
          </button>
        </div>
      </FormCard> */}
      {/*  <FormCard step={2}>
        ...
        <div className="flex justify-between items-center mt-6">
          <button className="border border-gray-800 px-8 py-2 cursor-pointer text-lg rounded-md text-gray-800 flex items-center space-x-2 ">
